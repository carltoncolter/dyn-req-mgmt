namespace Plugins.Common.Constants
{
    ...
    {
        public const string RegardingConfigMismatch = "The regarding object config entity type does not match the regarding object's type";
