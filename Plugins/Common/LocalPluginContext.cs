    ...
    public class LocalPluginContext : ILocalPluginContext
    {
        ...
        public void Trace(CultureInfo cultureInfo, string format, params object[] args)
        {
            ...
            if (args != null)
            {
                ...
                {
                    message = string.Format(cultureInfo, format, args[0]);
                }
                else
                {
                    message = string.Format(cultureInfo, format, args);
                }
            }
        ...
        /// <inheritdoc />
        public void Trace(string format, params object[] args) => Trace(null, format, args);

        public void Trace(string message) => Trace(null, message, null);

        public void Trace(CultureInfo cultureInfo, string format) => Trace(cultureInfo, format, null);
        #endregion
    }
}